...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		final ServiceRegistryRequestDTO createCarServiceRequest = createServiceRegistryRequest(CarProviderConstants.GET_SERVO_SERVICE_DEFINITION, CarProviderConstants.CAR_URI, HttpMethod.POST);		
	...
	public void customDestroy() {
		//Unregister service
		arrowheadService.unregisterServiceFromServiceRegistry(CarProviderConstants.GET_SERVO_SERVICE_DEFINITION);
