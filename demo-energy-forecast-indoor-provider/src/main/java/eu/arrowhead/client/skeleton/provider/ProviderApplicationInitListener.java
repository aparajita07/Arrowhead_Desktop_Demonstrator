...
import ai.aitia.demo.energy_forecast.indoor_provider.CarProviderConstants;
...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		final ServiceRegistryRequestDTO createCarServiceRequest = createServiceRegistryRequest(CarProviderConstants.GET_TEMP_SERVICE_DEFINITION, CarProviderConstants.CAR_URI, HttpMethod.POST);		
		...
		ServiceRegistryRequestDTO getTempServiceRequest = createServiceRegistryRequest(CarProviderConstants.GET_TEMP_SERVICE_DEFINITION,  CarProviderConstants.CAR_URI, HttpMethod.GET);
		getTempServiceRequest.getMetadata().put(CarProviderConstants.REQUEST_PARAM_KEY_TEMP, CarProviderConstants.REQUEST_PARAM_TEMP);
	...
	public void customDestroy() {
		...
		arrowheadService.unregisterServiceFromServiceRegistry(CarProviderConstants.GET_TEMP_SERVICE_DEFINITION);
	}
